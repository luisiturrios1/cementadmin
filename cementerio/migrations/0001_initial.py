    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[
                 ('TR', 'Terreno regular'), ('GF', 'Gaveta Familiar')], default='TR', max_length=2)),
                ...
                ('beneficiario', models.CharField(
                    default=None, max_length=200, null=True)),
                ('recibo_pago', models.FileField(default=None, null=True,
                 upload_to=cementerio.models.terreno.recibo_pago_path)),
                ('fecha_regitro', models.DateTimeField(auto_now_add=True)),
                ('fecha_venta', models.DateField(default=None, null=True)),
                ('cliente', models.ForeignKey(default=None, null=True,
                 on_delete=django.db.models.deletion.SET_NULL, related_name='terrenos', to='cementerio.Cliente')),
                ('creado_por', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, default=None, null=True,
                                    on_delete=django.db.models.deletion.SET_NULL, related_name='difuntos', to='cementerio.Terreno'),
        ),
    ]
